...
class StudentCollectionImpl extends Object implements StudentCollection{
   ...
   public Hashtable<String,Places> students;
   ...
   public StudentCollectionImpl() {
      ...
      students = new Hashtable<String,Places>();
   ...
   public boolean resetFromJsonFile(){
      ...
      try{
         ...
         while (it.hasNext()){
            ...
            Places stud = new Places(studentJson);
   ...
   public boolean saveToJsonFile(){
      ...
      try {
         ...
         for (Enumeration<String> e = students.keys(); e.hasMoreElements();){
            Places aStud = students.get((String)e.nextElement());
   ...
   public boolean add(Places aStud){
      boolean ret = true;
   ...
   public Places get(String aName){
      Places ret = new Places("unknown","unknown","unknown","unknown","unknown","unknown","unknown","unknown");
      Places aStud = students.get(aName);
      if (aStud != null) {
         ret = aStud;
      }
      return ret;
