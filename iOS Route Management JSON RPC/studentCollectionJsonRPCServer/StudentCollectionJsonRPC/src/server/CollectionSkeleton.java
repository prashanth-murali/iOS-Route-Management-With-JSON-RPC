   ...
   public String callMethod(String request){
      ...
      try{
         ...
         if(method.equals("resetFromJsonFile")){
            ...
            Places stud = new Places(studJson);
            boolean added = mLib.add(stud);
            result.put("result",added);
         }else if(method.equals("get")){
            String sName = params.getString(0);
			/*String sDescription = params.getString(1);
			String sCategory = params.getString(2);
			String sAddress_title = params.getString(3);
			String sAddress_street = params.getString(4);
			String sElevation = params.getString(5);
			String sLatitude = params.getString(6);
			String sLongitude = params.getString(7);*/
            Places stud = mLib.get(sName);
